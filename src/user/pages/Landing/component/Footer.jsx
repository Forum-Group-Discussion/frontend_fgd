        ...
        <div id="footer" className="footer bg-primary-black p-10">
            <div className='max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-5 sm:grid-cols-3 grid-cols-2 gap-8 text-white'>
                <div id="footer-company" className="lg:col-span-2 sm:col-span-3 col-span-2">
                    ...
                    <p id="footer-company-desc" className='py-4'>234  A Street Markin,  Shanen , USA</p>
                </div>
            ...
            <div id="footer-contact">
                <h6 id="footer-socmed-title" className="text-white text-center mt-10 font-bold">Find Us</h6>
                ...
                <h6 id="footer-copyright" className="text-white text-center mt-10 pb-10">Copyright © 2022 TeamName</h6>
            </div>
        </div>
    )
}
    ...
    return(
        <section id="review" className="bg-primary-black p-[5%]">
            <div className="max-w-[1240px] mx-auto flex flex-col md:gap-20 gap-10">
                <div id="review-title" className="text-white font-bold md:text-4xl md:mx-[0] text-3xl mx-auto">Review</div>
                <div id="review-desc" className="text-white text-center mx-auto md:text-xl font-medium max-w-[600px]">What user say about <span className="font-bold md:text-2xl text-lg">Found</span>?</div>
                <div id="review-content" className="w-full shadow-xl flex flex-col p-4 py-[15%] rounded-lg bg-primary-grey relative" data-aos="zoom-in">
                    <div id="review-content-text" className="text-white text-center sm:max-w-[40%] mx-auto">{reviews[counter]}</div>
                    <img id="review-content-identity" src={photos[counter]} className="w-[200px] mx-auto sm:mt-[5%] mt-[10%]" alt="" />
                    <img id="review-quotation-1" src={Petik1} className="petik1 sm:absolute sm:block hidden"></img>
                    <img id="review-quotation-2" src={Petik2} className="petik2 sm:absolute sm:block hidden"></img>

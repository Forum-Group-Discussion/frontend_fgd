...
export default function AboutUs(){
    ...
    return(
        <section className="bg-primary-black p-[5%]">
            ...
            <div className="w-full shadow-xl flex flex-col p-4 py-10 rounded-lg bg-primary-grey" data-aos="zoom-in">
                {isFirst &&
                    <div className="grid md:grid-cols-5 lg:gap-15 gap-5 mx-auto my-20">
                ...
                { !isFirst && 
                    <div className="grid md:grid-cols-4 gap-20 mx-auto my-20">

            ...
            <section id="greet-1" className="bg-primary-black p-[10%] h-[100vh] lg:block flex flex-col justify-center">
                <div className="max-w-[1240px] flex lg:justify-between mx-auto justify-center">
                    <div id="greet-1-desc">
                        ...
                        <div className="mt-5 text-white sm:text-5xl text-3xl font-bold"><span className="uppercase text-secondary-yellow">unlimited</span> Discussion</div>
                        ...
                        <Link to='' className="mt-10 text-white font-semibold sm:text-2xl text-lg tracking-wider sm:p-5 p-4 inline-block rounded-full bg-secondary-orange border-secondary-orange hover:text-secondary-orange border hover:bg-primary-black ease-in-out duration-300 ">Get Started</Link>
                    </div>

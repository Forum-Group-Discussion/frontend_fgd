...
export default function Hello() {
  return (
    <div>
      <section className="bg-primary-black p-[10%] h-[100vh] sm:block flex flex-col justify-center">
        <div className="max-w-[1240px] flex lg:justify-between mx-auto justify-center">
          <div>
            ...
            <Link to="/login" className="mt-10 text-white font-semibold text-2xl tracking-wider p-5 inline-block rounded-full bg-secondary-orange border-secondary-orange hover:text-secondary-orange border hover:bg-primary-black ease-in-out duration-300 ">
              Get Started
            </Link>
          </div>
          <img src={Saly38} alt="logo" className="lg:h-[500px] hidden lg:block" />
        </div>
      </section>

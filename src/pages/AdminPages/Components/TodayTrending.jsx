  ...
  return (
    <div id="trending">
      <div className="rounded-md border-gray-500/10 border-2 p-5">
        <div id="title" className="grid grid-cols-4 mb-1 sm:mb-3">
        ...
        <div id="trending-list" className="list-decimal font-light lg:leading-10 xl:leading-7 xl:text-base text-sm py-3 lg:py-0">
          <li>Technology</li>
          <li>Games</li>
          <li>Education</li>
          <li>Health</li>

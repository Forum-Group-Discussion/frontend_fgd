                ...
                <div id="setting-img" className="py-5 place-self-center">
                  {imgProfile === null || imgProfile === "" ?
                    <div className="bg-primary-black border-2 border-[#d9d9d91a] rounded-full">
                      <FaUserAlt className="p-2 h-[100px] w-[100px] rounded-full scale-50 ml-[-10%] sm:ml-0 sm:scale-100 aspect-square" />
                    </div>
                    :
                    <img src={`data:image/jpeg;base64,${imgProfile}`} className="rounded-full w-[100px] h-[100px]" alt="img-user" />
                  }

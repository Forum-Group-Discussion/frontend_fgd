        ...
        <div className="mainRegister flex justify-center items-center fixed">
            ...
            <form action="" className="flex flex-col gap-y-3 self-center w-3/4">
                <div className="flex flex-col gap-y-8">
                    ...
                    <input id="address" name="address" type="text" className="h-11 rounded-xl p-2 outline-none border-none lg:text-sm md:text-sm text-xs" placeholder="Address" value={users.address} onChange={handleOnChange} required />

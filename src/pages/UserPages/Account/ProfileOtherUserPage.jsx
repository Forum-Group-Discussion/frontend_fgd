                ...
                <div id="acc-details" className="border-b-2 border-[#d9d9d91a] pb-[5%] text-white md:mx-[0] mx-auto">
                    ...
                    <div id="acc-details" className="grid gap-2 md:gap-y-5 mt-[-20%] sm:mt-[-7%] ml-[3%]">
                        <div className="flex justify-between relative">
                            ...
                            {follow
                            ? <button onClick={handleFollow} className="bottom-0 md:-bottom-5 right-[3%] absolute text-md sm-text-xl md:text-2xl px-4 py-2 md:px-6 md:py-3 bg-primary-grey rounded-xl sm:rounded-2xl text-white">Followed</button>
                            : <button onClick={handleFollow} className="bottom-0 md:-bottom-5 right-[3%] absolute text-md sm-text-xl md:text-2xl px-4 py-2 md:px-6 md:py-3 bg-secondary-orange rounded-xl sm:rounded-2xl text-white">Follow</button>
                            }
                        </div>

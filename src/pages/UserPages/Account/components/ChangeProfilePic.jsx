...
export default function ChangeProfilePic({ closePopupProfPic, imgProfile }) {
      ...
      <div className="bg-white py-6 px-16 rounded-lg">
        ...
        <div className="flex flex-col w-full">
          ...
          <button
            ...
            className="text-sm sm:text:xl my-3 text-primary-blue font-bold text-center border-b-1 border-black"
          >
            Upload Photo
          </button>
          <button onClick={handleRemoveProfile} className="text-sm sm:text:xl my-3 text-secondary-red font-bold">
            Remove Current Photo
          </button>
          <button onClick={closePopupProfPic} className="text-sm sm:text:xl text-primary-black font-bold my-3">
            Cancel
          </button>
        </div>
      </div>

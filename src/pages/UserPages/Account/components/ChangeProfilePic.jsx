    ...
    const handleRemoveProfile = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axiosInstance.post("v1/user/deleteimage",
                ).then((response) => {
        ...
        <div className="flex w-2/5 justify-center items-center">
            <div className="bg-white py-6 px-16 rounded-lg">
                ...
                <div className="flex flex-col w-full">
                    ...
                    <button onClick={handleRemoveProfile} className="text-sm sm:text:xl my-3 text-secondary-red font-bold">Remove Current Photo</button>

...
export default function EditThread() {
  const [value, setValue] = useState({ title: "Title", topic: "Games" });
  const [content, setContent] = useState("<h1><strong>semangat yaa... :D</strong></h1>");
  const fotoThread = useRef(null);
  const [error, setError] = useState({ errTitle: "", errTopic: "" });
        ...
        <form id="form" onSubmit={handleSubmit}>
          ...
          <div id="content-box" className="mb-[6%] sm:mb-[2%] mt-[3%] text-sm sm:text-md">
            ...
            <div id="text-editor" className="editor">
              <ReactQuill modules={modules} theme="snow" onChange={setContent} value={content} placeholder="Write Something..." className="h-[60%]" />
            </div>
          </div>

...
export default function AboutUs(){
    ...
    return(
        <section id="about" className="bg-primary-black p-[5%]">
            <div className="max-w-[1240px] mx-auto flex flex-col md:gap-20 gap-10">
                <div id="about-title" className="text-white font-bold md:text-4xl md:mx-[0] text-3xl mx-auto">About Us</div>
                <div id="about-desc" className="text-white text-center mx-auto md:text-xl font-medium max-w-[600px]">We provide a place for you to reach out and discuss all the information you need</div>
                <div id="about-content" className="w-full shadow-xl flex flex-col p-4 py-10 rounded-lg bg-primary-grey" data-aos="zoom-in">
                    {isFirst &&
                        <div id="about-content-1" className="grid md:grid-cols-5 lg:gap-15 gap-5 mx-auto my-20">
                            <button><MdNavigateBefore size={70} id="about-content-1-slide-left" className="hidden"/></button>
                            ...
                            <button><MdNavigateNext size={70} id="about-content-1-slide-right" className="fill-white mx-auto rounded-full bg-primary-purple" onClick={onClick}/></button>
                        </div>
                    }
                    { !isFirst && 
                        <div id="about-content-2" className="grid md:grid-cols-4 gap-20 mx-auto my-20">
                            <button><MdNavigateBefore size={70} id="about-content-2-slide-left" className="fill-white mx-auto rounded-full bg-primary-purple" onClick={onClick} /></button>
                            ...
                            <button><MdNavigateNext size={70} id="about-content-2-slide-left" className="hidden" /></button>
                        </div>
                    }
                </div>
            </div>

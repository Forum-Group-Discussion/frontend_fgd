    ...
    return(
        <section id='features' className="bg-primary-black p-[5%]">
            <div className="max-w-[1240px] mx-auto flex flex-col md:gap-20 gap-10">
                <div id='features-title' className="text-white font-bold md:text-4xl md:mx-[0] text-3xl mx-auto">Features</div>
                <div id='features-desc' className="text-white text-center mx-auto md:text-xl font-medium max-w-[600px]">Our features will help you explore your world. Find your friends and space with just one click</div>
